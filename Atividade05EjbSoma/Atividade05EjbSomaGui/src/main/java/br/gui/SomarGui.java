 ...
 * @author rafar
 */
public class SomarGui extends javax.swing.JFrame {

    /**
     * Creates new form SomarGui
     */
    public SomarGui() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SomarGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
